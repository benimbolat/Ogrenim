    ...
    return Scaffold(
      ...
      body: Center(
        child: Row(
          ...
          children: <Widget>[Expanded(child: SolWidgetA()), Expanded(child: SagWidgetA())],
        ),
      ),
    );
  }
...
//Sen bi string şehir bilgisi al = sen yukarı baktığın zaman görüğün providerları al.
// <bunların içerisinde STATEDATA yayını yapanları bul.> .
//sonrada şehir bilgisini al.
